                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{route('checkout.store', $camps->id)}}" class="basic-form" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="card_number" class="form-control {{$errors->has('card_number') ? 'is-invalid' : ''}}"  required>
                            ...
                            <div class="mb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="month" name="expired" class="form-control {{$errors->has('expired') ? 'is-invalid' : ''}}"  required>
                                ...
                                @endif
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="number" name="cvc" class="form-control {{$errors->has('cvc') ? 'is-invalid' : ''}}" maxlength="3"  required >
                                        @if ($errors->has('cvc'))
