                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{route('checkout.store', $camps->id)}}" class="basic-form" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="phone" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" value="{{old('phone') ?: Auth::user()->phone;}}"  required>
                                @if ($errors->has('phone'))
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="address" class="form-control {{$errors->has('address') ? 'is-invalid' : ''}}" value="{{old('address') ?: Auth::user()->address;}}"  required>
